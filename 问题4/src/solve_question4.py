...
SCENARIOS = [
    ...
    Scenario("growth8", "老人增长率8%", eta=0.13, note="60+老人净增长率调至8%，对应新增老人比例13%"),
...
从综合敏感性指数看，最敏感的情景为“{top_sensitive}”，最稳定的情景为“{most_robust}”。预算提高会直接改变可建设规模并把覆盖率提升至 100%，因此敏感性最高；老人净增长率提高到 8% 后，第5年老人总量明显增加，在 120 万元预算下覆盖率下降并触发站点重构，敏感性仅次于预算调整；转移概率的小幅变化主要影响站点位置和满意度，影响有限。运营成本增加20%主要通过提高价格倍率来维持利润率，并未改变站点集合、覆盖率、满意度和补贴，因此在纳入价格变化后的综合指数中仍表现较稳定。
